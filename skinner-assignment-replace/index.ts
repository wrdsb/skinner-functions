...
const skinnerAssignmentReplace: AzureFunction = async function (context: Context, triggerMessage: string): Promise<void> {
    ...
    let event = {
        ...
        eventType: 'Skinner.Assignment.Replace',
...
export default skinnerAssignmentReplace;