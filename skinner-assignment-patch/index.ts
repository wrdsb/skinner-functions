...
const skinnerAssignmentPatch: AzureFunction = async function (context: Context, triggerMessage: string): Promise<void> {
    ...
    let event = {
        ...
        eventType: 'Skinner.Assignment.Patch',
...
export default skinnerAssignmentPatch;